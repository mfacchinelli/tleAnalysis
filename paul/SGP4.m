function [POS,VEL] = SGP4(TSINCE,XMO,XNODEO,OMEGAO,EO,XINCL,XNO,BSTAR)
%SGP4 This function is used to calculate the position and velocity of
%satellites. tsince is time since epoch in minutes, tle is a pointer to a
%tle_t structure with Keplerian orbital elements and pos and vel are
%vector_t structures returning ECI satellite position and velocity.
